[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=7575995&assignment_repo_type=AssignmentRepo)
# a05 Human Interface
...
```
curl https://localhost:5000/app/flip/
```
```json
{"flip":"tails"}
```
...
```
curl https://localhost:5000/app/flips/4
```
```
...
#### Response body
```
curl  https://localhost:5000/app/log/access
```
```json
